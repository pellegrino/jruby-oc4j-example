...
Warbler::Config.new do |config|
  ...
  config.includes = FileList["db/production.sqlite3"]
  ...
  config.java_libs.delete_if {|f| f =~ /jruby/}
  config.java_libs += FileList["/lib/jruby-rack*.jar"]
  config.java_libs += FileList["/lib/jruby*.jar"]
  ...
  config.gems += ["activerecord-jdbcsqlite3-adapter", "jruby-openssl", 'jdbc-sqlite3']
  # config.gems << "tzinfo"
